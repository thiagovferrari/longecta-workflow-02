...
export const CalendarSidebar: React.FC<CalendarSidebarProps> = ({ 
  ...
  return (
    <div className="bg-black/40 border border-white/10 rounded-3xl p-8 h-full flex flex-col backdrop-blur-xl shadow-2xl">
      ...
      <div className="grid grid-cols-7 gap-y-4 text-center mb-10">
        ...
        {Array.from({ length: daysInMonthCount }).map((_, i) => {
          ...
          return (
            ...
            >
              <span className={`text-sm z-10 transition-all ${
                isSelected ? 'text-black font-extrabold scale-110' : 'text-gray-400 group-hover:text-white'
              }`}>
                {day}
              </span>
